                  ...
                  >
                    ...
                    >
                      <Collapse.Panel
                        key='content'
                        title={
                          <div className='text-sm font-semibold text-blue-200 uppercase tracking-wider pl-4'>
                            Content Management
                          </div>
                        }
                      >
                      ...
                      >
                        ...
                        >
                          ...
                          <List.Item
                            prefix={<MessageSquare className='h-4 w-4 text-blue-200' />}
                            onClick={() => handleNavigate('/admin/chat-history')}
                            className='text-white pl-4 bg-[#265e79]'
                            arrow={false}
                          >
                            Chatbot History
                          ...
                          <List.Item
                            prefix={<MessageSquare className='h-4 w-4 text-blue-200' />}
                            onClick={() => handleNavigate('/admin/chat-feedback')}
                            className='text-white pl-4 bg-[#265e79]'
                            arrow={false}
                          >
                            Chatbot Feedback
