 ...
 *
 * This is a test implementation to evaluate TanStack Table for replacing
 * custom table code in AdminDiveSites.js
 */
const AdminDiveSitesTable = ({
  data = [],
  columns,
  pagination,
  onPaginationChange,
                ...
                <tr>
                  ...
                  >
                    <div className='flex flex-col items-center justify-center'>
                      ...
                      <p className='text-gray-500 text-lg font-medium'>No dive sites found</p>
                ...
                table.getRowModel().rows.map((row, index) => (
                  ...
                  >
                    {row.getVisibleCells().map(cell => {
                      ...
                      const shouldWrap =
                        columnId === 'name' || columnId === 'tags' || columnId === 'aliases';
                      return (
                        <td
                          key={cell.id}
                ...
                <div key={row.id} className='p-4 hover:bg-gray-50'>
                  ...
                  <div className='grid grid-cols-2 gap-2 mt-3 text-xs'>
                    <div>
                      ...
                      <span className='text-gray-900'>{site.id}</span>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <span className='text-gray-900'>
                        {site.average_rating
                          ? `${site.average_rating.toFixed(1)}/10`
                          : 'No ratings'}
                      </span>
                    </div>
                    <div>
                    ...
                    {site.country && (
                      <div>
                        ...
                        <span className='text-gray-900'>{site.country}</span>
                      </div>
                    )}
                  </div>
                  {(site.tags?.length > 0 || site.aliases?.length > 0) && (
                    <div className='mt-3 flex flex-wrap gap-1'>
                      ...
                      {site.aliases?.slice(0, 2).map(alias => (
                        <span
                          key={alias.id}
      ...
      <div className='flex flex-col sm:flex-row justify-between items-center gap-4'>
        ...
        {pagination.totalCount !== undefined && (
          <div className='text-sm text-gray-600'>
            ...
            {pagination.totalCount} dive sites
          </div>
        )}
