  ...
  return (
    <div className='mb-6 space-y-4'>
      ...
      {incomingRequests.length > 0 && (
        <div className='bg-white dark:bg-gray-800 sm:rounded-lg shadow-md overflow-hidden border border-blue-100 dark:border-blue-900/30'>
          <div className='bg-blue-50 dark:bg-blue-900/20 px-3 sm:px-4 py-2 border-b border-blue-100 dark:border-blue-900/30'>
          ...
          <div className='divide-y divide-gray-100 dark:divide-gray-700'>
            {incomingRequests.map(req => {
              ...
              return (
                <div
                  key={req.id}
                  className='p-3 sm:p-4 flex items-center justify-between gap-2 sm:gap-4 hover:bg-interactive-hover dark:hover:bg-interactive-hover-dark transition-colors'
                >
                  ...
                  <div className='flex space-x-2 shrink-0'>
                    <button
                      ...
                      className='p-1.5 sm:p-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors shadow-sm'
                      title='Accept'
                    >
                      <UserCheck size={18} />
                    </button>
                    <button
                      ...
                      className='p-1.5 sm:p-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-500 dark:text-gray-300 rounded-lg transition-colors'
                      title='Ignore'
                    >
                      <UserX size={18} />
                    </button>
      ...
      {outgoingRequests.length > 0 && (
        <div className='bg-white dark:bg-gray-800 sm:rounded-lg shadow-md overflow-hidden border border-gray-100 dark:border-gray-700'>
          <div className='bg-gray-50 dark:bg-gray-900/40 px-3 sm:px-4 py-2 border-b border-gray-100 dark:border-gray-700'>
