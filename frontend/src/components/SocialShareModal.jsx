              ...
              {photos.map((photo) => (
                <button
                  ...
                  className={`relative aspect-square rounded-md overflow-hidden border-2 transition-all ${
                    selectedImage?.id === photo.id ? 'border-blue-500 ring-2 ring-blue-200' : 'border-transparent'
                  }`}
                >
            ...
            <div className="grid grid-cols-1 gap-2">
              <button
                ...
                className={`flex items-center justify-between px-3 py-2 rounded-lg border text-sm transition-colors ${
                  aspect === 1 ? 'bg-blue-50 border-blue-200 text-blue-700' : 'bg-white border-gray-200 text-gray-600 hover:bg-gray-50'
                }`}
              >
              ...
              <button
                ...
                className={`flex items-center justify-between px-3 py-2 rounded-lg border text-sm transition-colors ${
                  aspect === 4/5 ? 'bg-blue-50 border-blue-200 text-blue-700' : 'bg-white border-gray-200 text-gray-600 hover:bg-gray-50'
                }`}
              >
                <div className="flex items-center gap-2">
                  <Maximize2 className="w-4 h-4" />
              ...
              <button
                ...
                className={`flex items-center justify-between px-3 py-2 rounded-lg border text-sm transition-colors ${
                  aspect === 9/16 ? 'bg-blue-50 border-blue-200 text-blue-700' : 'bg-white border-gray-200 text-gray-600 hover:bg-gray-50'
                }`}
              >
                <div className="flex items-center gap-2">
                  <Maximize2 className="w-4 h-4" />
