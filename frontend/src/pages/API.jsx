                ...
                <div className='mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200'>
                  ...
                  <div className='space-y-4 text-blue-800 text-sm'>
                    <p>
                      ...
                      <strong>Personal Access Tokens (PATs)</strong>. These are long-lived tokens
                      that bypass the CAPTCHA requirement.
                    </p>
              ...
              <div>
                ...
                <div className='mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200'>
                  ...
                  <ul className='list-disc list-inside space-y-1 text-gray-700 text-sm'>
                    ...
                    <li>
                      Use <code className='bg-gray-100 px-1 rounded'>-v</code> flag for verbose
                      output to see headers and response details
                    </li>
                    <li>
