...
const AdminNotificationPreferences = () => {
  ...
  return (
    <>
      <SEO
        title='Divemap - Admin - Notification Preferences'
      ...
      <div className='w-full max-w-full py-4 sm:py-6 pr-4 sm:pr-6 pl-2 sm:pl-4'>
        <div className='mb-6'>
          ...
          <p className='text-gray-600 mt-2'>
            View and modify notification preferences for any user
          </p>
        </div>
            ...
            {!selectedUserId ? (
              <div className='bg-white rounded-lg shadow p-12 text-center'>
                ...
                <p className='text-gray-600'>
                  Select a user to view their notification preferences
                </p>
              </div>
            ) : (
            ...
            {batchForm.operation === 'create' && (
              <div className='bg-yellow-50 border border-yellow-200 rounded-lg p-3'>
                <p className='text-sm text-yellow-800'>
                  <strong>Note:</strong> If a preference already exists for a user, it will be
