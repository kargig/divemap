...
const AdminEditRequests = () => {
  ...
  return (
    <>
      <SEO title='Divemap - Admin - Edit Requests' description='Divemap Admin Dashboard' />
      <div className='w-full max-w-full py-4 sm:py-6 pr-4 sm:pr-6 pl-2 sm:pl-4'>
        <div className='mb-8'>
          ...
          <p className='text-gray-600 mt-2'>
            Review and moderate community dive site contributions.
          </p>
        </div>
                        ...
                        <tbody className='bg-white divide-y divide-gray-200'>
                          {(() => {
                            ...
                            if (req.edit_type === 'media_update') {
                              ...
                              const currentMedia = req.dive_site?.media?.find(
                                m => m.id === mediaId
                              );
                              return Object.entries(req.proposed_data)
                                .filter(([key, val]) => key !== 'id' && val !== null && val !== '')
                                .map(([key, newValue]) => {
                                  const currentValue = currentMedia
                                    ? currentMedia[key]
                                    : 'Not found';
