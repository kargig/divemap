...
const AdminGeneralStatistics = () => {
  ...
  return (
    <>
      <SEO title='Divemap - Admin - General Statistics' description='Divemap Admin Dashboard' />
      <div className='w-full max-w-full py-4 sm:py-6 pr-4 sm:pr-6 pl-2 sm:pl-4'>
        {/* Header */}
        <div className='mb-8'>
              ...
              <div className='bg-white p-6 rounded-lg border shadow-sm'>
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-2xl font-bold text-gray-900'>
                      {formatNumber(
                        notificationAnalytics?.email_delivery?.sent_directly_to_ses || 0
                      )}
                    </p>
                  ...
                  <div className='space-y-2'>
                    <div className='flex items-center justify-between'>
                      ...
                      <span className='text-sm font-medium text-gray-900'>
                        {formatNumber(
                          notificationAnalytics.time_stats.last_24h?.notifications || 0
                        )}
                      </span>
                    </div>
                    <div className='flex items-center justify-between'>
                ...
                <div className='bg-white p-6 rounded-lg border shadow-sm'>
                  ...
                  <div className='space-y-2'>
                    <div className='flex items-center justify-between'>
                      ...
                      <span className='text-sm font-medium text-gray-900'>
                        {formatNumber(
                          notificationAnalytics.time_stats.last_30d?.notifications || 0
                        )}
                      </span>
                    </div>
                    <div className='flex items-center justify-between'>
