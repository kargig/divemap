...
from app.models import DiveSite, DiveRoute, DivingCenter, Dive
...
REQUIRED_FILES = ["dive-sites.md", "dive-routes.md", "diving-centers.md", "dives.md", "llms.txt"]
...
def upload_to_r2(client, filename, content):
    ...
    try:
        client.put_object(
            ...
            ContentType='text/markdown' if filename.endswith('.md') else 'text/plain'
        )
